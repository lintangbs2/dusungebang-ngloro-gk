...
function UMKMDetail() {
  ...
  let data: UMKMCard | undefined = dataUMKMUnggulan.find(
    (item) => item.title === name.replace("%20", " ")
  );
          ...
          <div className="col-span-4">
            ...
            >
              ...
              <a
                ...
                href={data?.googleMapsLink || "https://maps.google.com/maps"}
              >
                <span className="!text-[#F3C725] hover:text-[#dfc979] text-lg">
                            ...
                            <div className="flex flex-col items-start justify-start gap-1 ">
                              {product.deskripsi
                                ...
                                .map((description, index) => (
                                  <p key={index} className="!text-[#686867]">
                                    {description}
                                  </p>
                                ))}
