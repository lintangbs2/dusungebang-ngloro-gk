...
function AboutGallery() {
  return (
    <div className="flex flex-col justify-center">
      <h2 className="mx-auto !text-[#272726]">Gallery</h2>
      <div
      ...
      >
        {aboutGallery.map((image, index) => (
          <div
           ...
           hover:scale-105 transition-all duration-400 ease-in-out  overflow-hidden
           "
          >
            <Image
              src={image.image}
              ...
              group-hover:scale-110 ease-in-out duration-400
              "
            />
          </div>
        ))}
