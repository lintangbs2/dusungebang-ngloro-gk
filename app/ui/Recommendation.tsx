  ...
  return (
    <div className="flex flex-col gap-y-4 pl-1 pr-6 pt-8 container  ">
      <div className="grid grid-cols-1 gap-y-2 md:grid-cols-2 lg:gap-x-8 ">
        <h2 className="hyphens-auto ">Recommendation Tour</h2>
